  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      if (isOptimisticConcurrencyError(errMsg)) {
        ...
        setFormError("Bu tedarikçi için aynı fatura veya sevk irsaliyesi numarasıyla daha önce bir satın alma fişi oluşturulmuş. İşlem iptal edildi; yeni fiş, stok hareketi veya lot oluşturulmadı. Eksik ürünü mevcut fişi düzenleyerek ekleyebilirsiniz.");
      } else {
        setFormError(errMsg);
      }
    } finally {
